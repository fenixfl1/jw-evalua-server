...
export class Migration1755542231311 implements MigrationInterface {
    name = 'Migration1755542231311'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ACTION" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
        await queryRunner.query(`ALTER TABLE "PERMISSION_X_ROLE" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
        await queryRunner.query(`ALTER TABLE "PERMISSION" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
        await queryRunner.query(`ALTER TABLE "MODULE" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
        await queryRunner.query(`ALTER TABLE "STAFF_X_MODULE" RENAME COLUMN "UPDATED_ATA" TO "UPDATED_AT"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" ADD "CREATED_BY" integer`);
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" ADD "CREATED_AT" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "STAFF_X_MODULE" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`ALTER TABLE "MODULE" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`ALTER TABLE "PERMISSION" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`ALTER TABLE "PERMISSION_X_ROLE" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`ALTER TABLE "ACTION" RENAME COLUMN "UPDATED_AT" TO "UPDATED_ATA"`);
        await queryRunner.query(`CREATE INDEX "IDX_cfb5ba942f33086e54cec02624" ON "ROLES_X_USER" ("ROLE_ID") `);
        await queryRunner.query(`CREATE INDEX "IDX_6014c0ac471a029270386464b0" ON "ROLES_X_USER" ("USER_ID") `);
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" ADD CONSTRAINT "FK_6014c0ac471a029270386464b0e" FOREIGN KEY ("USER_ID") REFERENCES "USERS"("USER_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "ROLES_X_USER" ADD CONSTRAINT "FK_cfb5ba942f33086e54cec026244" FOREIGN KEY ("ROLE_ID") REFERENCES "ROLE"("ROLE_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
