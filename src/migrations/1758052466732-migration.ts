...
export class Migration1758052466732 implements MigrationInterface {
    name = 'Migration1758052466732'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "public"."period_type_enum_old_old" RENAME TO "period_type_enum_old_old_old"`);
        ...
        await queryRunner.query(`ALTER TABLE "GOAL_X_MODULE" ADD CONSTRAINT "FK_b039f29a765d956bdc1f58695f7" FOREIGN KEY ("GOAL_ID") REFERENCES "GOAL"("GOAL_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "GOAL_X_MODULE" ADD CONSTRAINT "FK_57f6c35613cdb8166a35a84ab73" FOREIGN KEY ("MODULE_ID") REFERENCES "MODULE"("MODULE_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "GOAL_PROGRESS" ADD CONSTRAINT "FK_8745e33981fba7993185d1fe91a" FOREIGN KEY ("GOAL_ID") REFERENCES "GOAL"("GOAL_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "GOAL_PROGRESS" ADD CONSTRAINT "FK_fae48ace910f3f1d3222a74e808" FOREIGN KEY ("MODULE_ID") REFERENCES "MODULE"("MODULE_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "GOAL_X_STAFF" ADD CONSTRAINT "FK_2f94bbcd2ed9d11ea9906f130bb" FOREIGN KEY ("GOAL_ID") REFERENCES "GOAL"("GOAL_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "GOAL_X_STAFF" ADD CONSTRAINT "FK_fa1652ed9617ba07fed1a555372" FOREIGN KEY ("STAFF_ID") REFERENCES "STAFF"("STAFF_ID") ON DELETE NO ACTION ON UPDATE NO ACTION`);
