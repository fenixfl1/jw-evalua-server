...
export class Migration1755717769967 implements MigrationInterface {
  name = 'Migration1755717769967'
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ROLES_X_USER" ADD "ID" integer GENERATED BY DEFAULT AS IDENTITY NOT NULL`
    )
    await queryRunner.query(
      `ALTER TABLE "ROLES_X_USER" ADD CONSTRAINT "PK_e0e994e4f4cd602284d12f2cf97" PRIMARY KEY ("ID")`
    )
